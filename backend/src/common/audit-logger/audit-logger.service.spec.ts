...
describe('AuditLoggerService', () => {
  ...
  const mockLog = {
    _id: 'log-1', level: AuditLogLevel.INFO,
  ...
  describe('log', () => {
    it('should create audit log via Mongoose', async () => {
    ...
    it('should handle undefined params and result', async () => {
      await service.log({ eventType: AuditLogEventType.SYSTEM_INFO });
      expect(mockModel.create).toHaveBeenCalledWith(
        expect.objectContaining({ params: undefined, result: undefined }),
      );
    });
  });
  ...
  describe('logMethodStart/End/Error', () => {
    ...
    it('should log method end without duration', async () => {
  ...
  describe('logScan', () => {
    it('should log scan start with INFO level', async () => {
